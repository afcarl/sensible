...
if __name__ == '__main__':
    ...
    mu1 = np.array([[3277935.01596], [-10.227966282]])
    sigma1 = np.array([[(6.02 / z) ** 2, 0], [0, (1 / z) ** 2]])

    mu2 = np.array([[3277930.04858], [-10.4955549268]])
    sigma2 = np.array([[(5 / z) ** 2, 0], [0, (0.5 / z) ** 2]])

    mu3 = np.array([[3277958.95155], [-12.7852808187]])
    sigma3 = np.array([[(6.02 / z) ** 2, 0], [0, (1 / z) ** 2]])

    mu4 = np.array([[3277951.24602], [-12.9089678239]])
    sigma4 = np.array([[(5 / z) ** 2, 0], [0, (0.5 / z) ** 2]])

    plt.figure(1)

    gaussPlot2d.gauss_plot_2d(mu3, sigma3, chi_square=9.488, label='DSRC', color='b', annotation='18:16:50400')
    gaussPlot2d.gauss_plot_2d(mu4, sigma4, chi_square=9.488, label='Radar', color='y', annotation='18:16:50700')

    plt.title("DSRC to Radar association")
